...
this.stories = this.stories.filter(st => st.storyId !== storyId);

user.favorites = user.favorites.filter(st => st.storyId !== storyId);

user.ownStories= user.ownStories.filter(st => st.storyId !== storyId);
